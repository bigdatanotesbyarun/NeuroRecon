...
cursor.execute("DROP TABLE IF EXISTS ORDER_HIST")
# Create table query
create_table_query = """
...
data = [
    (111, "Order1", 1000, datetime.strptime("2023-09-01 10:10:10", "%Y-%m-%d %H:%M:%S"), 
     "Online", "Street A HIST", 123456, "State1", "District1", 1234567890),
    (222, "Order2", 2000, datetime.strptime("2023-09-02 11:12:12", "%Y-%m-%d %H:%M:%S"), 
     "Offline", "Street B HIST", 654321, "State2", "District2", 9876543210),
    (3333, "Order3", 1500, datetime.strptime("2023-09-03 09:09:09", "%Y-%m-%d %H:%M:%S"), 
     "Online", "Street C HIST", 456789, "State1", "District3", 1928374650),
    (444, "Order4", 2500, datetime.strptime("2023-09-04 12:12:12", "%Y-%m-%d %H:%M:%S"), 
     "Offline", "Street D HIST", 789456, "State3", "District1", 1231231230),
    (555, "Order5", 3000, datetime.strptime("2023-09-05 13:30:30", "%Y-%m-%d %H:%M:%S"), 
     "Online", "Street E HIST", 321654, "State2", "District2", 4564564560)
]
